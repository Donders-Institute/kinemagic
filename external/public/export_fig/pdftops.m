...
%% BEGIN HACK by Lennart
%xpdf_path = fullfile(filesep,'opt','ghostscript','bin','pdf2ps');
xpdf_path = fullfile(filesep,'home','common','matlab','eeg-tms','public','export_fig','xpdf','bin','pdftops');
%% END HACK
